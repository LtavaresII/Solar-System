...
void display(void)
{
   GLfloat light_position1[] = { 5.0, 0.0, -2.0, 1.0 };
   GLfloat light_position2[] = { -5.0, 0.0, -2.0, 1.0 };
   GLfloat light_position3[] = { 0.0, 5.0, -2.0, 1.0 };
   GLfloat light_position4[] = { 0.0, -5.0, -2.0, 1.0 };
